...
<script src="${basePath}/js/cn.tedu.ttms.common/page.js"></script>
<div class="container">
   <!-- 页面导航 -->
		...
		<div class="row page-search">
		 <div class="col-md-12">
			<ul class="list-unstyled list-inline">
				...
				<li><input type="text" id="email" class="form-control" placeholder="邮箱"></li>
				<li><input type="text" id="mobile" class="form-control" placeholder="手机号"></li>
