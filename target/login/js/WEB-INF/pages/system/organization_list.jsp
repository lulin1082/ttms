...
<script type="text/javascript" src="${basePath}/js/cn.tedu.ttms.common/page.js"></script>
<script type="text/javascript" src="${basePath}/js/system/organization_list.js"></script>
    <!-- 表单 -->
	<div class="container">
	   <!-- 页面导航 -->
