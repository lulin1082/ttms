...
<form  class="form-horizontal" role="form" id="editFormId">
	...
	<div class="form-group">
		<label for="cn.tedu.ttms.project-code" class="col-sm-2 control-label">项目编号:</label>
		<div class="col-sm-10">
		<input type="text" class="form-control required" name="code" id="codeId">
		</div>
	</div>
	<div class="form-group">
		<label for="cn.tedu.ttms.project-code"  class="col-sm-2 control-label">开始时间:</label>
		<div class="col-sm-10">
		<input type="text" class="form-control datepicker " name="code" id="beginDateId">
		</div>
	</div>
	<div class="form-group">
		<label for="cn.tedu.ttms.project-code" class="col-sm-2 control-label">结束时间:</label>
		<div class="col-sm-10">
...
<c:url var="url" value="/js/cn.tedu.ttms.project/project_edit.js"></c:url>
