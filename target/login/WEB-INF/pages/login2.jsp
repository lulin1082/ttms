...
<div class="login-box" id="rrapp">
    <div class="login-logo">
        <img src="${basePath }/images/logo_login2.png" alt="logo" />
        <b>旅游管理系统</b>
    </div>
    <div class="login-box-body">
        ...
        <div class="row">
            <div class="col-xs-12">
                <input type="checkbox" name="remeberMe" id="remeberMe" class="checkbox"/>remeberMe
                <%--
                          //  <input id="rememberMe" type="hidden" name="rememberMe" value="false"/>
                --%>
